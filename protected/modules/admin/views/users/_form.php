...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'postal_code_letter'); ?>
		<?php echo $form->textField($model,'postal_code_letter',array('size'=>2,'maxlength'=>2)); ?>
		<?php echo $form->error($model,'postal_code_letter'); ?>
	</div>
