...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'category_id',CHtml::listData(LibCategory::model()->findAll(),'id','name'),array('empty' => 'Select a name')); ?>
		<?php echo $form->error($model,'category_id'); ?>
	</div>
        
	<div class="row">
		<?php echo $form->labelEx($model,'status'); ?>
		<?php echo $form->dropDownList($model,'status',CHtml::listData(LibAnnouncementStatus::model()->findAll(),'id','name'),array('empty' => 'Select a name')); ?>
