...
class Comments extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('announcement_id, text', 'required'),
			array('announcement_id, user_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, announcement_id, text, add_date, change_date, user_id', 'safe', 'on'=>'search'),
		);
	}
