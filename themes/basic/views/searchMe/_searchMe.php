                        ...
                        if(!hasError){
                            $.ajax({
                                ...
                                if(json.status=="saved"){
                                    ...
                                    url = "'.Yii::app()->createUrl('searchMe/create').'",
                                    document.getElementById("searchMeForm").reset();  
                ...
                <div >
                    ...
                    <td>
                     ...
                     <div >
                        ...
                        <?php echo $form->textField($model,'zipcode',array('size'=>20,'maxlength'=>8,'class'=>"form-control searchMe",'placeholder'=> '1234 XX')); ?>
        ...
        <?php $this->endWidget(); ?>
            ...
            <h4>
               <b> Wij houden u op de hoogte van advertenties waar u naar opzoek bent, komen de trefwoorden<br/>
                ...
                <b>Voorbeeld<br />Bmw,3-serie,2001,benzine</b>
