...
U heeft zojuist en bod van € <?php echo $model->sum; ?>,- uitgebracht op de advertentie : <?php echo CHtml::link('show announcement', Yii::app()->params['siteUrl'].Yii::app()->createUrl('site/show',array('id' =>$model->announcement->id))); ?> <br />
...
Link naar advertentie: <?php echo CHtml::link('show announcement', Yii::app()->params['siteUrl'].Yii::app()->createUrl('site/show',array('id' =>$model->announcement->id))); ?> <br />

Prijs: <?php echo $model->announcement->libStatus->name; ?>  <br />
